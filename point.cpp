 ...
 * whose X value is set to the leftmost function input value and 
 * whose Y value is set to the rightmost function input value.
 * 
 ...
 * y := mx + b.
 * 
 * // m is a constant which represents the rate at which y changes when x changes.
