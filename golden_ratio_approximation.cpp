 ...
 * Note that the largest of the two adjacent Fibonacci Sequence terms, A, is divided by the smallest of the two adjacent Fibonacci Sequence terms, B.
 * 
 ...
 * C := A / B. 
 * 
 * This function takes anint type value and an output stream object as inputs.
