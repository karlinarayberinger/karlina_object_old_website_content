...
#define PI 3.141592653589793238462643383279502884197169399 // Define the constant PI to represent the approximate value of a circle's circumference divided by its diameter.
 ...
 * 
 * X represents a specific whole number position along the x-axis (horizontal dimension) of a two-dimensional Cartesian grid.
 * Y represents a specific whole number position along the y-axis (vertical dimension) of the same two-dimensional Cartesian grid.
 */
class POINT
{
private:
